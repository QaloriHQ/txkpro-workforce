    ...
    <>
      ...
      <main className="page-wrap txk-prototype-content">
        <PageHeader
          ...
          title={course.title}
          description="Preview the learner experience interactively. Simulation state is local to this page and never creates Student completion evidence."
          actions={
            <ButtonLink href={`/employer/learning/${encodeURIComponent(course.microCertId)}`}>
              <ArrowLeftIcon aria-hidden="true" /> Back to overview
            </ButtonLink>
          }
        />
        <CourseAuthoringNav microCertId={course.microCertId} active="preview" />
